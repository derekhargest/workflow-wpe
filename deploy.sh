...
#rsync 
rsync --rsh="ssh -v -p 22 -i ${WPE_SSHG_KEY_PRIVATE_PATH} -o StrictHostKeyChecking=no -o 'ControlPath=$SSH_PATH/ctl/%C'" $FLAGS --exclude-from='./exclude.txt' $SRC_PATH "$WPE_DESTINATION"
